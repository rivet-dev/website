...
- **Actor-to-actor communication:** Actors interact through [actions](/actors/docs/actions) and [events](/actors/docs/events), so they don't need to coordinate access to shared data. This makes it easy to distribute them across machines.
