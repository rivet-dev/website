...
- [Custom Agents](/agentos/docs/agents/custom): the agent-focused guide.
- [Building Binaries](/agentos/docs/custom-software/building-wasm): compile WASM commands and use the registry.
- [Packages & command resolution](/agentos/docs/architecture/packages-and-command-resolution): how packages mount and resolve.
