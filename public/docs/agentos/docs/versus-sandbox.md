...
| **Credentials** | Stay on the host. [Bindings](/agentos/docs/bindings) run your functions server-side; agents see only inputs and outputs. | Must be injected into the sandbox environment. |
