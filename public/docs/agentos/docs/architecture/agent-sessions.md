...
- [Sessions](/agentos/docs/sessions) for the public API.
- [Sessions & Persistence](/agentos/docs/architecture/sessions-persistence) for SQLite and restoration.
- [Approvals](/agentos/docs/approvals) for ACP permission options.