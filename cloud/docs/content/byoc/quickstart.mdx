...
<Step title="Get your metrics token">

On your project's BYOC page in the [Rivet dashboard](https://dashboard.rivet.dev), open **Metrics ingest token** and click **Create token**. Copy it now, it's shown only once.

You'll be asked for this token while provisioning. See [Shipping metrics](/cloud/byoc/shipping-metrics) for how metrics reach Rivet.
