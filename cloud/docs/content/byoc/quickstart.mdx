...
See [Configuration](/docs/deploy/byoc/configuration) for more settings.
...
Follow the [Credentials & dashboard guide](/docs/deploy/byoc/credentials).
...
- [Kubernetes](/docs/deploy/self-host/workers/kubernetes)
- [AWS ECS](/docs/deploy/self-host/workers/aws-ecs)
- [Google Cloud Run](/docs/deploy/self-host/workers/gcp-cloud-run)
- [AWS Lambda](/docs/deploy/self-host/workers/aws-lambda)
- [More options](/docs/deploy/self-host/workers)

</Step>
</Steps>

To share cluster metrics after deployment, follow [Shipping metrics](/docs/deploy/byoc/shipping-metrics).
