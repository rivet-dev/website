...
export function EnterpriseCloud() {
	return (
		<Info>
			...
			<p>Please <a href="/talk-to-an-engineer/">reach out for access</a> for access to Rivet Cloud. To deploy RivetKit without Rivet Cloud, see our <a href="/docs/deploy/self-host/control-plane/">self-hosting documentation</a>.</p>
		</Info>
	)
}
