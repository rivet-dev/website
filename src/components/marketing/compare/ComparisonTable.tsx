			...
			<table className="w-full min-w-[760px] border-collapse [&_a]:text-pine [&_a]:underline [&_a]:decoration-pine/40 [&_a]:underline-offset-2 [&_a:hover]:text-ink">
				<thead>
					<tr className="border-b border-ink/15">
						<th className="w-[18%] py-4 pl-0 pr-4 text-left text-sm font-medium text-ink-faint">
							Feature
						</th>
						...
						<th className="w-[26%] py-4 pl-4 pr-0 text-left text-sm font-medium text-ink-faint">
							Why it matters
						</th>
					</tr>
				</thead>
					...
					{featureGroups.map((group) => (
						<React.Fragment key={group.title}>
							<tr className="border-b border-ink/10">
								<td
									colSpan={4}
									className="pb-3 pl-0 pt-12 text-sm font-medium text-ink-faint"
								>
									{group.title}
								</td>
							</tr>
