...
const useCases: Record<string, UseCaseConfig> = {
  'AI Agent': {
    ...
    features: [
      { icon: Cpu, label: 'In-memory state', detail: 'Context', href: '/actors/docs/state' },
      { icon: Database, label: 'SQLite or BYO database persistence', detail: 'Memory', href: '/actors/docs/state' },
      { icon: Clock, label: 'Scheduling', detail: 'Tool calls', href: '/actors/docs/schedule' },
    ],
...
await job.run();`,
  ...
  'Collab Docs': {
    ...
    features: [
      { icon: Cpu, label: 'In-memory state', detail: 'Document', href: '/actors/docs/state' },
      { icon: Wifi, label: 'WebSockets', detail: 'Sync', href: '/actors/docs/events' },
      { icon: Zap, label: 'Runs indefinitely', detail: 'Always on', href: '/actors/docs/lifecycle' },
    ],
...
doc.on("update", (state) => render(state));`,
  ...
  'Per-Tenant Database': {
    ...
    features: [
      { icon: Cpu, label: 'In-memory state', detail: 'Hot reads', href: '/actors/docs/state' },
      { icon: Database, label: 'SQLite or BYO database persistence', detail: 'Tenant data', href: '/actors/docs/state' },
      { icon: Zap, label: 'Sleeps when idle', detail: 'Cost efficient', href: '/actors/docs/lifecycle' },
    ],
...
const user = await tenant.getUser("u1");`,
  ...
  'Sandbox Orchestration': {
    ...
    features: [
      { icon: Cpu, label: 'In-memory state', detail: 'Live sessions', href: '/actors/docs/state' },
      { icon: Database, label: 'Queue messages', detail: 'Jobs', href: '/actors/docs/queues' },
      { icon: Clock, label: 'Scheduling', detail: 'Timeouts', href: '/actors/docs/schedule' },
    ],
...
sandbox.on("runComplete", (result) => render(result));`,
  ...
  'Chat': {
    ...
    features: [
      { icon: Cpu, label: 'In-memory state', detail: 'Room state', href: '/actors/docs/state' },
      { icon: Database, label: 'SQLite or BYO database persistence', detail: 'History', href: '/actors/docs/state' },
      { icon: Wifi, label: 'WebSockets', detail: 'Realtime', href: '/actors/docs/events' },
    ],
