...
seoDescription: "Discover RivetKit backend libraries for building durable application features in your own code, without depending on a growing collection of SaaS APIs."
---
...
<img src={oldway.src} alt="An application depends on separate database, queue, durable execution, and realtime services" />

### With rivetkits: Just A Library & Your Database

<img src={newway.src} alt="RivetKit consolidates durable compute, realtime, scheduling, and persistence inside the application" />
...
See the [RivetKit + Better Auth integration](/integrations/better-auth).
