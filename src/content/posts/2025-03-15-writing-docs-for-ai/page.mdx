...
seoTitle: "How to Write Documentation for AI Coding Tools"
seoDescription: "Structure developer documentation so AI coding tools like Cursor, Windsurf, and Claude Code can understand APIs, examples, and workflows reliably."
---
