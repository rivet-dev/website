...
seoTitle: "Build an AI-Powered Linear Agent with Rivet"
seoDescription: "Build a complete Linear coding agent with Node.js and Rivet, including authentication, webhooks, issue assignments, comments, and generated code."
---

export const imgAuthLinear = { src: "https://assets.rivet.dev/website/blog/2025-05-28-building-linear-agents-in-node-js-and-rivet-full-walkthrough-and-starter-kit/auth-linear.png", width: 2908, height: 2106, format: "png" };
export const imgAppSetup = { src: "https://assets.rivet.dev/website/blog/2025-05-28-building-linear-agents-in-node-js-and-rivet-full-walkthrough-and-starter-kit/app-setup.png", width: 1202, height: 2378, format: "png" };
