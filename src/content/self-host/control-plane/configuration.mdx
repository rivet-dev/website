...
It grants every operation in every namespace, cannot be scoped, and cannot be revoked without a restart. Keep it on your backend and use it to mint scoped credentials rather than shipping it anywhere else. See [Authentication](/docs/authentication).
