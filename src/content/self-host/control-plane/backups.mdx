...
FoundationDB has its own backup agent and continuous backup support. Backup topology is covered during enterprise onboarding. Contact [enterprise support](/talk-to-an-engineer/).
