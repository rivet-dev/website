---
title: "Self-Host"
description: "Choose self-hosting, BYOW (Bring Your Own Workers), or fully managed BYOC (Bring Your Own Cloud)."
---
...
See <SelfHostLink to="workers">worker deployment options</SelfHostLink> and manage your project in the [Rivet dashboard](https://dashboard.rivet.dev).
...
See the [BYOC quickstart](/cloud/byoc/quickstart).
