...
<svg viewBox="0 0 760 230" role="img" aria-label="Fully managed architecture: your worker runs on Rivet Compute alongside the control plane and storage, all inside Rivet Cloud." style="width:100%;max-width:760px;height:auto;display:block;margin:2.5rem auto;font-family:system-ui,sans-serif">
  <defs><marker id="cloud-managed-arrow" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#2E4034"/></marker></defs>
  <rect x="20" y="25" width="720" height="180" rx="10" fill="#faf8f3" stroke="#2E4034" stroke-width="1.4" stroke-dasharray="7 6"/>
  <rect x="48" y="65" width="214" height="120" rx="8" fill="none" stroke="#2E4034" stroke-width="1" stroke-opacity=".45"/>
  <g font-size="11" font-family="ui-monospace,monospace" font-weight="600" letter-spacing="0.14em" fill="#2E4034"><text x="42" y="51">RIVET CLOUD</text><text x="66" y="89">RIVET COMPUTE</text></g>
  <g stroke="#1b1916" stroke-width="1.4"><rect x="70" y="103" width="170" height="64" rx="7" fill="#ffffff"/><rect x="317" y="103" width="170" height="64" rx="7" fill="#e7ece7"/><rect x="542" y="103" width="170" height="64" rx="7" fill="#ffffff"/></g>
  <g text-anchor="middle" fill="#1b1916"><text x="155" y="129" font-size="14" font-weight="600">Worker</text><text x="155" y="149" font-size="12" fill="#56524a">(your code)</text><text x="402" y="141" font-size="14" font-weight="600">Control plane</text><text x="627" y="141" font-size="14" font-weight="600">Storage</text></g>
  <g stroke="#2E4034" stroke-width="1.4"><line x1="263" y1="135" x2="316" y2="135" marker-start="url(#cloud-managed-arrow)" marker-end="url(#cloud-managed-arrow)"/><line x1="488" y1="135" x2="541" y2="135" marker-start="url(#cloud-managed-arrow)" marker-end="url(#cloud-managed-arrow)"/></g>
</svg>
