...
description: "Deploy a directory or generated files with deployApp(), repair TypeScript, and configure regions and scaling."
skill: true
---
...
[AI App Builder example](https://github.com/rivet-dev/dynamic-apps/tree/main/examples/apps-ai-builder).
