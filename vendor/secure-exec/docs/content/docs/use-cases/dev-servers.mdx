...
- **One VM per preview.** Each tenant's server gets its own VM, filesystem,
  and [limits](/secure-exec/docs/resource-limits).
...
Read more in [Long-Running Code](/secure-exec/docs/long-running-code).
