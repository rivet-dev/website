...
See [Pool Configuration](/docs/pool-configuration) for how pools are scaled, drained on version upgrades, and rate-limited during actor eviction.
...
See [Server Setup](/actors/docs/http-server/) for more configuration options.
