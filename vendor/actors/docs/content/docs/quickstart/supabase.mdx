...
Ready to ship? See [Deploying to Supabase Functions](/docs/deploy/self-host/control-plane).
...
- [Deploying to Supabase Functions](/docs/deploy/self-host/control-plane)
