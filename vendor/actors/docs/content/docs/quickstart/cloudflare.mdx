...
Ready to ship? See [Deploying to Cloudflare Workers](/docs/deploy/self-host/control-plane).
...
- [Deploying to Cloudflare Workers](/docs/deploy/self-host/control-plane)
