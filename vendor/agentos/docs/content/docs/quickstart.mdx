...
- **[Host functions](/agentos/docs/host-functions)** expose your JavaScript functions to agents as CLI commands.
...
The `@rivet-dev/agentos-core` package exports `AgentOs.create()` for embedded VM
control without the actor lifecycle, multiplayer, or orchestration layer.
