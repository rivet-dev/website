...
- **Context injected.** agentOS adds a system prompt describing the VM environment, available commands, and host functions, layered on top of the agent's own instructions. See [System Prompt](/agentos/docs/system-prompt).
