...
| **Credentials** | Stay on the host. [Host functions](/agentos/docs/host-functions) run your functions server-side; agents see only inputs and outputs. | Must be injected into the sandbox environment. |
